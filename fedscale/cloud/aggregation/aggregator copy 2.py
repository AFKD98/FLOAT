...
class Aggregator(job_api_pb2_grpc.JobServiceServicer):
    ...
    def __init__(self, args):
        ...
        self.buffer_size = args.buffer_size or 10
    ...
    def update_client_dropped_out(self, client_id, exe_cost):
        logging.info(f"Client {client_id} dropped out at round {self.round}")
        self.clients_dropped_out.append(client_id)
        self.dropped_clients_resource_usage.append(exe_cost)
        ...
        self.dropped_clients_resource_usage_per_round[self.round].append(exe_cost)
        ...
        while True:
            ...
            # Handle events queued on the aggregator
                ...
                if current_event == commons.UPLOAD_MODEL:
                    ...
                    if self.mode == 'async':
                        logging.debug(f"Faraz - Async mode: {len(self.stats_util_accumulator)}")

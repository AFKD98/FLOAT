...
class AsyncAggregator(Aggregator):
    ...
    def _new_task(self, event_time):
        ...
        """
        try:
            if event_time > self.clients_dropped_per_duration[-1]:
            ...
            if participation_feasibility:
                ...
                if client in self.clients_dropped_per_duration[event_time]:
    ...
    def update_weight_aggregation(self, results):
        ...
        try:
            if type(results) is not list and self.mode!='Fedbuff':

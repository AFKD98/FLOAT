...
export MAIN_PATH=/home/ahmad/REFL
# the path to the dataset, note $dataset, the dataset name passed as argument to script
export DATA_PATH=/home/ahmad/REFL/dataset/data/${dataset}
#the path to the conda envirnoment
export CONDA_ENV=/home/ahmad/anaconda3/envs/refl
...
# The entity or team used for WANDB logging, should be set correctly, typically should be set your WANDB ahmadID
export WANDB_ENTITY=""
...
tags="central" #"r-safa" #"badstale" #"avail" #"central" #"motive2" "motive1" #"safa1" #"avail" #"stale" # #"avail" #"safa" "r-safa"  "delta"
export TAGS=$tags

...
class DataPartitioner(object):
    ...
    def __init__(self, data, numOfClass=0, seed=10, isTest=False, isVal=False):
        self.partitions = []
        self.rng = Random()
        self.rng.seed(seed)
    ...
    def create_mapping(self, sizes):
        numOfLabels = self.getNumOfLabels()
        #Faraz - seeting partitioning manually
        self.args.partitioning = 4
...
def select_dataset(rank, partition, batch_size, isTest=False, isVal=False, collate_fn=None, seed=0):
